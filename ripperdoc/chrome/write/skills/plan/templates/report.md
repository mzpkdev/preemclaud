...
1 <Name> <N> files 2 <Name> ← #1 <N> files 3 <Name> ← #1, #2 <N> files

──────────────────────────────────────────────────────────────────

1 <Name> C \<exact/path/to/new-file.ext> M \<exact/path/to/existing-file.ext>
...
2 <Name> ← #1 M \<exact/path/to/file.ext>
