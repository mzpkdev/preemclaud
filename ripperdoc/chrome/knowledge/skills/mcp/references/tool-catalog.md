...
1. [Tool-by-Tool Recommendations](#tool-by-tool-recommendations)
1. [MCP Server Catalog](#mcp-server-catalog)

______________________________________________________________________

## Admin access warnings

Some tools require tokens that only an admin or org owner can create. When recommending these tools, warn the user if
they might need to involve their admin.
...
**No admin needed:** Jira CLI (personal API token), New Relic, Vercel, Supabase, Linear, Bugsnag — any user can create
their own tokens.
...
Quick-install commands for all verified MCP servers. After adding HTTP servers that need OAuth, run `/mcp` inside Claude
