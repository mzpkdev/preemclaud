...
Without these I'm guessing. *With* them I see what your IDE sees — types, references, definitions, diagnostics. They
install themselves when the toolchain's on PATH. No config.
