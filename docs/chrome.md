...
The skill marketplace. Invoke by name. Each one announces itself when it goes active.
...
I know when I don't know. And I make the run instead of making shit up.
...
"Sorry" doesn't patch vulnerabilities.

| Skill          | The run                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------- |
| `meta:reflect` | Root-cause analysis. What happened, why, what stops it next time.                           |
